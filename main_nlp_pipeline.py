...
FOLDER_PATH=r"C:\Users\Binish\Desktop\Financial News Analyzer\data"
OUTPUT_FOLDER_PATH=r"C:\Users\Binish\Desktop\Financial News Analyzer\output"
...
def extract_entities(info,ner_model,ner_labels,event_classifier,event_labels,sentiment_model,topk=3,label_threshold=0.3):
    for content in info:
        ...
        gt=event_classifier(content["text"],event_labels,multi_label=True,hypothesis_template="The main event discussed in the article is {}")
